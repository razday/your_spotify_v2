...
export function runMigrations() {
  load(
    {
      migrations: {
        "1618162835253-add_global_preferences.js": {
          up: add_global_preferences,
          down: noop,
        },
        "1620176626899-add_nb_elements.js": { up: add_nb_elements, down: noop },
        "1620235555105-add_best_metric_type.js": {
          up: add_best_metric_type,
          down: noop,
        },
        ...
        "1645792294982-fix_first_listened_at.js": {
          up: fix_first_listened_at,
          down: noop,
        },
        "1708973485300-create_private_data.js": {
          up: create_private_data,
          down: noop,
        },
        "1708973485301-add_metadata_to_infos.js": {
          up: add_metadata_to_infos,
          down: noop,
        },
